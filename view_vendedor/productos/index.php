...
<th><a class="a1" href="../../../TroyaNW/View_Vendedor/productos/agregar.php"><img src="../../img/mas.svg"></a></th></tr>
...
$queryusuarios = mysqli_query($conn, "SELECT producto.idproducto, producto.nombreproducto, categorias.nombrecategorias, producto.salidaproducto, producto.entradaproducto, producto.stockproducto, producto.valorproducto, producto.IVAproducto, proveedor.nombreProveedor FROM producto, proveedor, categorias WHERE producto.idcategoria=categorias.idcategorias AND producto.documentoproveedor=proveedor.documentoProveedor AND nombreproducto like '".$buscar. "%'");
}
else
{
$queryusuarios = mysqli_query($conn, "SELECT producto.idproducto, producto.nombreproducto, categorias.nombrecategorias, producto.salidaproducto, producto.entradaproducto, producto.stockproducto, producto.valorproducto, producto.IVAproducto, proveedor.nombreProveedor FROM producto, proveedor, categorias WHERE producto.idcategoria=categorias.idcategorias AND producto.documentoproveedor=proveedor.documentoProveedor ORDER BY idproducto asc");
}
$numerofila = 0;
