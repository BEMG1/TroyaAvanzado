...
<div class="contenedor_iniciales">
    ...
    <div class="barrabuscar">
        <form method="POST">
            ...
            <table>
            <tr><th colspan="7"><h1>Salidas</h1><th><a class="a1" href="../../../TroyaNW/admin/salidas/agregar.php"><img src="../../img/mas.svg"></a></th></tr>
            <tr>
        ...
        if(isset($_POST['btnbuscar']))
        {
            ...
            $querysalida = mysqli_query($conn, "SELECT salidas.idsalidas, producto.nombreproducto, ventas.numeroventas, salidas.fechasalidas, salidas.horsalidas, salidas.cantidadsalidas, FORMAT(salidas.valorsalidas, 'NO') as valorsalidas FROM salidas, producto, ventas WHERE salidas.idproductos=producto.idproducto AND salidas.numeroventa = ventas.numeroventas AND salidas.idsalidas like'".$buscar."%'");
        } 
        else
        {
        ...
        while ($mostrar = mysqli_fetch_array($querysalida)) 
        {
            ...
            echo "<td style='width=26%' colspan=2 ><a class=a1 href=\"editar.php?idsalidas=$mostrar[idsalidas]\"><img  src='../../img/edita.svg'></a> <a class=a1 href=\"eliminar.php?idsalidas=$mostrar[idsalidas]\" onClick=\"return confirm('¿desea eliminar a $mostrar[nombreproducto]?')\"><img src=../../img/delete.svg></a></td>";
                }
        ?>
        </table>
        <script>
