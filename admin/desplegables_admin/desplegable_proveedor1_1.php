...
<head>
  <meta charset="utf-8">
  <link rel="stylesheet" href="../desplegables_admin/menu1_4.css">
  <style>
...
<h2 class="iniciales1">T.N.W.I</h2>
  <ul id="navbar"> 
  <li <?php if ($currentPage == 'inicio') echo 'class="current disabled"'; ?>><a href="../ViewAdmin.php">Inicio</a></li>
    <li <?php if ($currentPage == 'categorias') echo 'class="current disabled"'; ?>><a href="../categorias/index.php">Categorias</a></li>
    <li <?php if ($currentPage == 'clientes') echo 'class="current disabled"'; ?>><a href="../clientes/Index.php">Clientes</a></li>
    <li <?php if ($currentPage == 'entradas') echo 'class="current disabled"'; ?>><a href="../entradas/index.php">Entradas</a></li>
    ...
    <li <?php if ($currentPage == 'proveedor') echo 'class="current disabled"'; ?>><a href="../proveedor/index.php">Proveedor</a></li>
    <li <?php if ($currentPage == 'salidas') echo 'class="current disabled"'; ?>><a href="../salidas/index.php">Salidas</a></li>
    <li <?php if ($currentPage == 'vendedores') echo 'class="current disabled"'; ?>><a href="../vendedores/index.php">Vendedores</a></li>
